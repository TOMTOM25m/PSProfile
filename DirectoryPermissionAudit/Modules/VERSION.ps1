...
$ScriptVersion = "v2.3.0"   # Modernized from legacy FolderPermissionReport v2.1.0.0
...
<#!
.VERSION HISTORY
v2.3.0 - $BuildDate - Module packaging, external HTML template, CI matrix, filtering & pruning, GUI updates
