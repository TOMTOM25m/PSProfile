...
"@
    ...
    function global:prompt {
        ...
        if ($global:IsAdmin) { 
            $userColor = "Red"
            $userText = "[$($env:USERNAME)@Admin]"
        } else { 
            $userColor = "Cyan"
            $userText = "[$($env:USERNAME)]"
        }
    ...
    # Initialize Git Status Cache for Legacy
    if (-not $global:GitStatusCache) { $global:GitStatusCache = @{} }
...
# --- End of Profile Template | Version: v24.0.0 | Regelwerk: v9.6.0 | Date: 2025-09-27 ---
