...
<#
.SYNOPSIS
    Show-CertWebService-FQDNs.ps1 - Zeigt alle CertWebService-Server mit vollständigen FQDNs
.DESCRIPTION
    Basierend auf den bereits gefundenen Servern - zeigt FQDN und URL-Informationen
#>
...
Write-Host "=== CertWebService-Server mit vollständigen FQDNs ===" -ForegroundColor Green
