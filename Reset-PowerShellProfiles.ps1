...
.NOTES
    ...
    old Version:    v09.03.00
    Version now:    v09.04.00
    MUW-Regelwerk:  v7.3.0
    Notes:          [DE] Regelwerk aktualisiert und an Skripte angepasst.
                    [EN] Ruleset updated and scripts adapted.
...
$Global:ScriptVersion = "v09.04.00"
$Global:RulebookVersion = "v7.3.0"
...
if ($Versionscontrol.IsPresent) {
    ...
    if ($null -ne $Global:Config) {
        Write-Log -Level DEBUG -Message "ConfigFile value before Invoke-VersionControl (Versionscontrol): '$ConfigFile'"
        Invoke-VersionControl -LoadedConfig $Global:Config -Path $ConfigFile
...
# --- End of Script --- old: v09.03.00 ; now: v09.04.00 ; Regelwerk: v7.3.0 ---