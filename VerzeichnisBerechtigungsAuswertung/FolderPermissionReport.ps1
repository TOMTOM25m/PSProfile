...
function WriteToLogFile {
    param( $logfilepath)
    #Add-Content -Path $logfilepath -Value $value -Encoding 'UTF8'
    Add-Content -Path $logfilepath[0] -Value $logfilepath[1]
}

function Out-File-UTF8-noBOM {
    param( $str, $dest )
        ...
        foreach ($currentItemName in $ACLArray) {
            ...
            if ($DOM) {
                ...
                if ($grp.ObjectClass -eq 'group') {
                    ...
                    Write-Host 'User oder Gruppe nicht definierbar'
                }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDMKeVYB+sYDERG
# GkTpN/tDT2dWA6aXKkhLhhB+f1jTV6CCFgEwggL2MIIB3qADAgECAhBXv4pDAvsn
...
# NwIBFTAvBgkqhkiG9w0BCQQxIgQgUYsp3elAK5uEGMMN9gpWMsMD7UVKpCoVPI2Q
# s0QnoLUwDQYJKoZIhvcNAQEBBQAEggEAtUP36A4cL4I61on8pbmP//DkURSt12r6
# lrB5dckb2UZucNUEMvBw5W4p3DyKAVo+3ezw5XJ7PmSN93qJje0tBW1MOBmknRc4
# Mwdt9ap8dmlaRgUl2V5qIYJp/w+lS961P8haNBKVxbLk3TzPcPutBAttxEy8OzPk
# pP5K5uf4M3CioFLxyyxNfI7HnIo3WeWrJiwbEo5BsRh/pr+nNyJi6M0rg0n9jvn+
# 2Z1eiFvfhMi/bwhUSDGob2l1D6TC4dTHY+Dy/FmDzNYWHfjpaENX020pQpLVy6Bs
# CRV4KtXlH3Ne1oUAsWgfvmSCLjAKBnJ5qEE3W+HG+1a0JYoBbSNdwaGCAyAwggMc
...
# SIb3DQEJBTEPFw0yMzAzMDgwOTM1MDlaMC8GCSqGSIb3DQEJBDEiBCDGdjJFDjfo
# 4VEB2Y+PDhYCTvgW5+rPvPTrRb8R+6x9KjANBgkqhkiG9w0BAQEFAASCAgCW26xj
# 6gKbzh2QzBg7oxLJeHxWlJtcMt6dOowsBdaTDAhgQGWxrppVm921g9qV+seBIuQ1
# XFhSbKhUFbroamOZJS36GNqdtS9wZhPySmRgwNajVz1fqbaVEoC+EvBIXktjJfUW
# 03bL2t4JEcCKsCezaPMqo27ag1MehQibDpNfzEBBiVBJd1NU5ug0967lxgHrwUW/
# opDhuKmuZ8JHHGPW4TRbmGcCX8XdvLeX9A56URvw9V8qhDyTXKUIfW8u01B9gCtv
# Qv1pbB29tovXJDS5ahKahJ9dh9JFXuHhxBg8dwFCBEJypIxYWpRnZb17crp5iYWF
# CVaheiDYrpRUKesoumx3LUOFi83nzQbOdUuaDnKQ4oCVw70x7bBiZQf7a8Usf9VD
# KIsP3Fsj50rJE1nPhV7xToS7IRxONCrmweXPqOtvGXnqwQ7uaDuuW7JTVtRzD7lk
# YKB2W84x2ee8TtBeOn4jQyiabVQjjE5qSQdR2/8lTkye8tm1MgeBqUqrbiXo6vVu
